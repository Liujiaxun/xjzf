...
class Login extends Component {
      ...
      this.props
        ...
        .then(res => {
          if (res.status) {
            ...
            if (res.data && res.data.phone && res.data.phone !== '') {
  ...
  componentDidMount() {
    ...
    this.props.dispatch({
      type: 'login/changeIsLoginStatus',
      payload: false,
    });
    ...
    return (
      <div className={styles.main}>
        <div className={styles.loginLeft}>
          ...
          <div className={styles.footer}>Copyright © 2018-2019 小微聚付</div>
        </div>
        {!isLogin ? (
              ...
              <Form onSubmit={this.handleSubmit}>
                ...
                <Form.Item>
                  <Row gutter={8}>
                    ...
                    <Col span={8}>
                      <Button
                        disabled={this.state.disabledGetCodeButton}
